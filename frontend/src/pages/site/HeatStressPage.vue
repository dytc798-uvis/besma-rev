<template>
  <div class="heat-page">
    ...
    <div class="manual-calc-bar">
      <button type="button" @click="openRecordModal">직접 입력·계산</button>
      <small>기상 조회 여부와 관계없이 온도·습도를 직접 입력해 체감온도를 계산할 수 있습니다.</small>
    </div>
...
.manual-calc-bar{display:flex;align-items:center;gap:12px;padding:14px 16px;border:1px solid #99f6e4;border-radius:14px;background:#f0fdfa}.manual-calc-bar small{color:#475569;line-height:1.45}
