...
RECEIPTS = (
    ...
    ("KakaoTalk_20260803_075542817_01.jpg", datetime(2026, 7, 30, 7, 41, 18), "쌍용-구로SGI", "도림주유소", 81_000, "주유비", "휘발유 44.142L"),
    ("KakaoTalk_20260803_075542817_02.jpg", datetime(2026, 7, 30, 15, 24, 56), "쌍용-구로SGI", "세미즈", 13_500, "간식비", "음료 4잔"),
...
def main(stage: Path) -> None:
    ...
    try:
        ...
        purpose_updates = {
            ...
            "20260725_060529.jpg": ("5.출퇴근용(왕복)", None),
        ...
        reconstructed_logs = (
            ...
            (date(2026, 7, 30), "정상익", None, 112.0, "6.업무용(왕복)", "쌍용-구로SGI"),
